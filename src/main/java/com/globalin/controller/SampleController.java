...
public class SampleController {
	...
	//리턴 결과가 jsp파일 이름이 되었는데,RestController는 순수한데이터를 준다.
	...
	public Map<String, SampleVO> getMap(){
		...
		map.put("Frist", new SampleVO(11,"그루트", "주니어"));
		return map;
	}
	...
	//각파라미터의 이름은 cat, pid이다.(값이 cat, pid는아님)
	//pathvaribale에는 기본자료형 사용x
	
	@GetMapping("/product/{cat}/{pid}")
	public String[] getPath(@PathVariable("cat") String cat, 
			@PathVariable("pid") Integer pid) {
		//String cat은 url에 {cat} 자리에 있는 값을 가져옴
